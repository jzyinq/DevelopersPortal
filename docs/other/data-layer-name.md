...
![Asynchronous container code - copy to clipboard](/_static/images/data_layer_name/install_manually_basic_container.png)
...
![Asynchronous container code - data layer name](/_static/images/data_layer_name/data_layer_name.png)
...
![Synchronous container code - copy to clipboard](/_static/images/data_layer_name/install_manually_additional_container.png)
...
![Synchronous container code - data layer name](/_static/images/data_layer_name/data_layer_name_additional_container.png)
...
![Piwik PRO WordPress plugin settings - data layer name](/_static/images/data_layer_name/data_layer_wp_plugin.png)
